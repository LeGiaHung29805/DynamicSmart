...
public class ShippingQuoteService {
    ...
    public ShippingQuoteResponse quote(ShippingQuoteRequest request) {
        var location = locations.validateForQuote(request.provinceId(), request.wardId());
        ...
        GhnClient.Rate rate = ghn.quote(location.districtId(), location.wardCode(), request.items());
